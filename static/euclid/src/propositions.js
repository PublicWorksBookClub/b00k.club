...
export const PROPOSITIONS = [
  {
    ...
    body: [
      ...
      { op: 'segment', id: 'l3', a: 'i0', b: 'l2' },
      { op: 'segment', id: 'l4', a: 'i1', b: 'l2' },
    ],
    outputs: ['l2', 'l3', 'l4'],
    uses: [],
    demo: {
...

  {
    ...
    body: [
      ...
      { op: 'macro', id: 'l1', tool: 'euclid.I.1', args: ['i0', 'i1'], out: ['l2', 'l3', 'l4'] },
      { op: 'ray', id: 'l5', a: 'l2', b: 'i0' },
      { op: 'ray', id: 'l6', a: 'l2', b: 'i1' },
      { op: 'circle', id: 'l7', o: 'i1', r: 'i2' },
      { op: 'inter', id: 'l8', c1: 'l6', c2: 'l7', branch: 1 },
      { op: 'circle', id: 'l9', o: 'l2', r: 'l8' },
      { op: 'inter', id: 'l10', c1: 'l5', c2: 'l9', branch: 1 },
      { op: 'segment', id: 'l11', a: 'i0', b: 'l10' },
    ],
    outputs: ['l10', 'l11'],
    uses: ['euclid.I.1'],
    demo: {
...

  {
    ...
    body: [
      ...
      { op: 'segment', id: 'l4', a: 'i0', b: 'i1' },
      { op: 'inter', id: 'l5', c1: 'l4', c2: 'l3', branch: 1 },
      { op: 'segment', id: 'l6', a: 'i0', b: 'l5' },
    ],
    outputs: ['l5', 'l6'],
    uses: ['euclid.I.2'],
    demo: {
